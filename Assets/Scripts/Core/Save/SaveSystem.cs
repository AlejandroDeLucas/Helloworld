...
{
    // Hotfix signature: compatibility build to avoid CS1061/CS0311 on mismatched local script-type setups.
    public class SaveSystem : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Debug.Log("[TinyHunter Hotfix] SaveSystem compatibility path active (typed equipment save/load disabled).");
        }
